...
<div class="d-flex flex-column-fluid">
    ...
    <div class="avatar-upload mb-3">
        ...
        <div class="avatar-preview">
            <div id="imagePreview" class="rounded" style="background-image: url({{ count($siswa) > 0 ? asset('storage/app/public/uploads/siswa/' . $siswa[0]['Foto']) : './assets/images/carousel/slide3.jpg' }});"></div>
        </div>
    </div>
