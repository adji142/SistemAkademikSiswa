								...
								@endif
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <button type="button" id="btNamaGuru" data-action="NamaGuru" class="btParameter btn btn-outline-secondary rounded-pill font-weight-bold me-1 mb-1">Nama Guru</button>
                                            <hr>
